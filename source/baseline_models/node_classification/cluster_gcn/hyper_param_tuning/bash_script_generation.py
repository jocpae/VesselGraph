...
hparam_dict = {
    'lr': [2.e-05, 1.e-04, 1.e-03, 3.e-03],  # np.logspace(-6, -3, 10),
    'num_layers': [3, 4, 5],
    'hidden_channels': [128, 256],  # 512
    'dropout': [0.2, 0.5],  # 0.0
    'num_partitions': [3, 9]  # 6
}
...
scripts_started = 0
with open('parallelize_cluster_gcn.sh', 'w+') as f:
    ...
    for i in range(comb):
        ...
        f.write(f'CUDA_VISIBLE_DEVICES={available_gpus[i % len(available_gpus)]} python cluster_gcn.py{param_str} &\n')
