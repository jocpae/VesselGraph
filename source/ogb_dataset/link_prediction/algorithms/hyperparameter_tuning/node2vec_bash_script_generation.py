...
parallel_starts = 8
available_gpus = available_gpus = ['6,0', '0,6']
...
scripts_started = 0
with open('node2vec_parallelize.sh','w+') as f:
    ...
    for i in range(comb):
        ...
        f.write(f'CUDA_VISIBLE_DEVICES={available_gpus[i%len(available_gpus)]} python node2vec_hyper.py {param_str} &\n')
