...
scripts_started = 0
with open('parallelize_mlp_cs.sh', 'w+') as f:
    ...
    for i in range(comb):
        ...
        f.write(f'CUDA_VISIBLE_DEVICES={available_gpus[i % len(available_gpus)]} python mlp_cs.py{param_str} &\n')
