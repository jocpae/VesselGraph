...
available_gpus = available_gpus = ['0,7', '7,0']


# args dict
args_dict = {'device': 7, # gpu
           'log_steps': 1,
           'num_layers': 3,
           'hidden_channels': 256,
           'dropout': 0.0,
...
hparam_dict = {
    'lr': [1.e-02, 1.e-03, 1.e-04,1.e-05],  # np.logspace(-6, -3, 10),
    'num_layers': [2, 3, 4],
...
scripts_started = 0
with open('final_mlp_parallelize.sh','w+') as f:
    ...
    for i in range(comb):
        ...
        f.write(f'python mlp_hyper_final.py{param_str} &\n')
