...
hparam_dict = {
    'lr': [1.e-06, 1.e-05, 1.e-04, 1.e-03, 1.e-02],  # np.logspace(-6, -3, 10),
    'num_layers': [2, 3, 4],
    'hidden_channels': [128, 256, 1024],
}
...
scripts_started = 0
with open('mf_parallelize.sh','w+') as f:
    ...
    for i in range(comb):
        ...
        f.write(f'python mf_hyper.py{param_str} &\n')
