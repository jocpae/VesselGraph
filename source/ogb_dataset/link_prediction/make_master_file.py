...
### add meta-information about vessap roi 1
name = 'ogbl-link_italo_spatial_no_edge_attr'
dataset_dict[name] = {'eval metric': 'mrr', 'task type': 'link prediction'}
dataset_dict[name]['download_name'] = 'link_italo_spatial_no_edge_attr'
dataset_dict[name]['version'] = 1
dataset_dict[name]['url'] = 'https://syncandshare.lrz.de/dl/fiVxePVqXFpsFmrXoCJnuKz8/link_italo_spatial_no_edge_attr.zip'
## For undirected grarph, we only store one directional information. This flag allows us to add inverse edge at pre-processing time
...
### add meta-information about vessap roi 1
name = 'ogbl-link_vessap_roi1_spatial_edge_attr'
dataset_dict[name] = {'eval metric': 'mrr', 'task type': 'link prediction'}
dataset_dict[name]['download_name'] = 'link_vessap_roi1_spatial_edge_attr'
dataset_dict[name]['version'] = 1
dataset_dict[name]['url'] = 'https://syncandshare.lrz.de/dl/fiGKnMoRr2YLp2D8qL7i8Y3w/link_vessap_roi1_spatial_edge_attr.zip'
## For undirected grarph, we only store one directional information. This flag allows us to add inverse edge at pre-processing time
dataset_dict[name]['add_inverse_edge'] = False # c.f. https://github.com/snap-stanford/ogb/issues/241
dataset_dict[name]['has_node_attr'] = True
dataset_dict[name]['has_edge_attr'] = True
...
### add meta-information about vessap roi 1
name = 'ogbl-link_vessap_roi1_spatial_no_edge_attr'
dataset_dict[name] = {'eval metric': 'mrr', 'task type': 'link prediction'}
dataset_dict[name]['download_name'] = 'link_vessap_roi1_spatial_no_edge_attr'
dataset_dict[name]['version'] = 1
dataset_dict[name]['url'] = 'https://syncandshare.lrz.de/dl/fi9P4JkocerufK87fjay6Ctc/link_vessap_roi1_spatial_no_edge_attr.zip'
## For undirected grarph, we only store one directional information. This flag allows us to add inverse edge at pre-processing time
dataset_dict[name]['add_inverse_edge'] = False # c.f. https://github.com/snap-stanford/ogb/issues/241
dataset_dict[name]['has_node_attr'] = True
dataset_dict[name]['has_edge_attr'] = False
...
dataset_dict[name]['version'] = 1
dataset_dict[name]['url'] = 'https://syncandshare.lrz.de/dl/fiCfkWzbfy2rJgfnSpQKT7pE/link_vessap_roi3_spatial_edge_attr.zip'
## For undirected grarph, we only store one directional information. This flag allows us to add inverse edge at pre-processing time
dataset_dict[name]['add_inverse_edge'] = False # c.f. https://github.com/snap-stanford/ogb/issues/241
dataset_dict[name]['has_node_attr'] = True
dataset_dict[name]['has_edge_attr'] = True
...
dataset_dict[name]['version'] = 1
dataset_dict[name]['url'] = 'https://syncandshare.lrz.de/dl/fi3BxTVXhutu6gDz7netnaZv/link_vessap_roi3_spatial_no_edge_attr.zip'
## For undirected grarph, we only store one directional information. This flag allows us to add inverse edge at pre-processing time
dataset_dict[name]['add_inverse_edge'] = False # c.f. https://github.com/snap-stanford/ogb/issues/241
dataset_dict[name]['has_node_attr'] = True
dataset_dict[name]['has_edge_attr'] = False
...
dataset_dict[name]['version'] = 1
dataset_dict[name]['url'] = 'https://syncandshare.lrz.de/dl/fiTzAKbNPnxhUEVEwMT3HAqG/BALBc_no1_spatial_edge_attr.zip'
## For undirected grarph, we only store one directional information. This flag allows us to add inverse edge at pre-processing time
dataset_dict[name]['add_inverse_edge'] = False # c.f. https://github.com/snap-stanford/ogb/issues/241
dataset_dict[name]['has_node_attr'] = True
dataset_dict[name]['has_edge_attr'] = True
...
dataset_dict[name]['version'] = 1
dataset_dict[name]['url'] = 'https://syncandshare.lrz.de/dl/fi2N4VWbpJox3dQDXnXQkJZS/BALBc_no1_spatial_no_edge_attr.zip'
## For undirected grarph, we only store one directional information. This flag allows us to add inverse edge at pre-processing time
dataset_dict[name]['add_inverse_edge'] = False # c.f. https://github.com/snap-stanford/ogb/issues/241
dataset_dict[name]['has_node_attr'] = True
dataset_dict[name]['has_edge_attr'] = False
