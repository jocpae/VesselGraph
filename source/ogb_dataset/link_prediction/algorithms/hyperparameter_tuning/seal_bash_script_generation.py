...
scripts_started = 0
with open('final_seal_parallelize.sh','w+') as f:
    ...
    for i in range(comb):
        ...
        f.write(f'CUDA_VISIBLE_DEVICES={available_gpus[i%len(available_gpus)]} python seal_link_pred_hyper.py --splitting_strategy spatial --use_feature {param_str} &\n')
