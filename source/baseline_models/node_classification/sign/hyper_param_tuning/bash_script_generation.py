...
hparam_dict = {
    'lr': [1.e-05, 1.e-04, 1.e-03, 5.e-3],  # np.logspace(-6, -3, 10),
    'num_layers': [3, 4],
    'hidden_channels': [64, 256, 512, 1024],  # 32, 128
    'dropout': [0.1, 0.5]  # 0.0, 0.3
}
...
scripts_started = 0
with open('parallelize_sign.sh', 'w+') as f:
    ...
    for i in range(comb):
        ...
        f.write(f'CUDA_VISIBLE_DEVICES={available_gpus[i % len(available_gpus)]} python sign.py{param_str} &\n')
