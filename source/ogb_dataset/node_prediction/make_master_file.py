...
### add meta-information about product category prediction task
name = 'ogbn-node_italo'
dataset_dict[name] = {'num tasks': 1, 'num classes': 10, 'eval metric': 'acc', 'task type': 'multiclass classification'}
dataset_dict[name]['download_name'] = 'node_italo'
dataset_dict[name]['version'] = 1
dataset_dict[name]['url'] = 'https://syncandshare.lrz.de/dl/fiSyHaRP4Xuksb1gPswAT8oi/node_italo.zip'
## For undirected grarph, we only store one directional information. This flag allows us to add inverse edge at pre-processing time
dataset_dict[name]['add_inverse_edge'] = False
dataset_dict[name]['has_node_attr'] = True
dataset_dict[name]['has_edge_attr'] = True
...
### add meta-information about product category prediction task
name = 'ogbn-node_BALBc_no1'
dataset_dict[name] = {'num tasks': 1, 'num classes': 10, 'eval metric': 'acc', 'task type': 'multiclass classification'}
dataset_dict[name]['download_name'] = 'BALBc_no1'
dataset_dict[name]['version'] = 1
dataset_dict[name]['url'] = 'https://syncandshare.lrz.de/dl/fiAkUkXC1MWh1dv4TfygdYkT/BALBc_no1.zip'
## For undirected grarph, we only store one directional information. This flag allows us to add inverse edge at pre-processing time
dataset_dict[name]['add_inverse_edge'] = False
dataset_dict[name]['has_node_attr'] = True
dataset_dict[name]['has_edge_attr'] = False
